...
import { WHATSAPP_NUMBER } from '../utils/whatsappHelper';
import './Footer.css';
...
const Footer = () => {
    ...
    const handleWhatsAppClick = () => {
        const message = encodeURIComponent("Hi! I'd like to know more about your handmade bead jewelry.");
            ...
            <div className="container">
                <div className="footer-content">
                    <div className="footer-section">
                        ...
                        <button className="btn btn-whatsapp btn-sm" onClick={handleWhatsAppClick}>
